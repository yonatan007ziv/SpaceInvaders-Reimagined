...
namespace GameWindow.Components.GameComponents.Bunker
{
    internal class Bunker
    {
        ...
        public Bunker(Vector2 pos)
        {
            ...
            parts.Add(new BunkerPart(BunkerPart.BunkerParts.MiddleBottomLeft, pos + new Vector2(-3, 3)));
            parts.Add(new BunkerPart(BunkerPart.BunkerParts.MiddleBottomRight, pos + new Vector2(3, 3)));
